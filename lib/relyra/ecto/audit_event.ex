if Code.ensure_loaded?(Ecto.Schema) do
  defmodule Relyra.Ecto.AuditEvent do
    @moduledoc false
    ...
    schema "relyra_audit_events" do
      field :domain, Ecto.Enum, values: @domain_values
      field :action, Ecto.Enum, values: @action_values
      field :actor, :string
      field :cause, :string
      field :correlation_id, :string
      field :before_summary, :map, default: %{}
      field :after_summary, :map, default: %{}
    ...
    def changeset(event, attrs) do
      ...
      |> validate_bounded_map(:before_summary, allow_empty?: true)
      |> validate_bounded_map(:after_summary)
