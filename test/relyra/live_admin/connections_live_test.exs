defmodule Relyra.LiveAdmin.ConnectionsLiveTest do
  @moduledoc """
  Wave 0 stub for the auto-refresh micro-badge extension on
  `Relyra.LiveAdmin.ConnectionsLive` (Phase 21 W4 — `21-06-live-admin-surface`).
  ...
  will be added in Wave 4 (`21-06`); see
  ...
  @tag :pending
  test "Wave 0 stub: replaced by Wave 4 task in Phase 21" do
    flunk("Wave 0 stub — implement in the wave that introduces the micro-badge extension")
  end
end
