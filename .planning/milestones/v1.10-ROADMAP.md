...
- [x] **Phase 72.1: Evaluator endpoint and trace-auth closure** - Connection-scoped evaluator endpoints and runtime-authenticated trace proof close the milestone audit gaps. (completed 2026-08-27)
