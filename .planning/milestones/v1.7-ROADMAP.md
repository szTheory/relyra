...
- [x] 52-01-PLAN.md - Run Relyra shipped migrations from dependency path

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 52-02-PLAN.md - Create deterministic LedgerLoop host data reset
- [x] 52-04-PLAN.md - Add fixed Ecto request and replay store wrappers
...
- [x] 52-06-PLAN.md - Prove signed Ecto-backed non-browser login path
...
| 52. Ecto Stores And Deterministic Seed Story | 6/6 | Complete   | 2026-06-12 |
