...
**Plans**: 4 plans
  ...
  - [x] 30-02-PLAN.md — New :adversarial_crypto suite: 5 categories + positive control + ECDSA carry-over + NEW c14n-differential :digest_mismatch (ASSUR-01/02)
  ...
  - [x] 30-04-PLAN.md — Name the suite into ci.security (D-08) + prove the full gate green (ASSUR-01)
