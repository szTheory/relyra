...
- [x] 70-01-PLAN.md — Tracer: proxy topology → audited descriptor trust → genuine signed ACS → receipt/Login Trace [KC-01]

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 70-02-PLAN.md — Provisioner idempotency, fail-closed behavior, audit evidence, and generated-key rotation [KC-01]
- [x] 70-03-PLAN.md — Split-horizon render contract, fresh realm lifecycle, and redacted layered diagnostics [KC-01]
...
- [x] 70-06-PLAN.md — Restore one-parse descriptor trust with one canonical candidate through audited persistence [KC-01]

**Wave 6** *(blocked on Plan 70-06)*

- [x] 70-07-PLAN.md — Eliminate sensitive Playwright artifact retention with fail-closed text-only diagnostics [KC-01]

**Wave 7** *(blocked on Plan 70-07)*

- [x] 70-08-PLAN.md — Authenticate the host-admin boundary and preserve safe Keycloak Login Trace proof [KC-01]

**Wave 8** *(blocked on Plan 70-08)*

- [x] 70-09-PLAN.md — Atomically co-commit the Sarah identity mapping, audit evidence, and final Keycloak enablement [KC-01]

**Wave 9** *(blocked on Plan 70-09)*

- [x] 70-10-PLAN.md — Close namespace-qualified multiline SAML diagnostic leakage and lock fail-closed admin credential coverage [KC-01]
...
- [x] 72-01-PLAN.md — Tracer: self-contained Solo/FakeIdP zero-to-login Docker guide, then Fleet/Keycloak/cache/recovery expansion [DOC-01]
...
- [x] 72-03-PLAN.md — Gap tracer: public fail-closed Keycloak/Fleet Make target with executable launcher coverage [DOC-01]
...
**Wave 5** *(blocked on Plan 72-04)*

- [x] 72-05-PLAN.md — Gap tracer: configured-port doctor/url recovery and reliable ordered documentation contracts [DOC-01, DOC-02]
...
- [x] 72.1-02-PLAN.md — Carry operator-chosen admin credentials through Compose and the Make-first preflight.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 72.1-03-PLAN.md — Align Solo/Fleet/Keycloak evaluator documentation with scoped routes and 401 recovery.
- [x] 72.1-04-PLAN.md — Prove denied-then-authenticated Keycloak trace access and run full security gates.
