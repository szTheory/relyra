...
**Plans**: 2 plans
- [ ] 68-01-PLAN.md — The build: Dockerfile.dev (cached dep layer, pinned base), docker-entrypoint.sh (lock-hash gate + ecto ordering), repo-root .dockerignore [DKR-01, DKR-03]
...
|-------|----------------|--------|-----------|
| 68. Build caching & correctness | 0/? | Not started | - |
