...
- [ ] 70-10-PLAN.md — Close namespace-qualified multiline SAML diagnostic leakage and lock fail-closed admin credential coverage [KC-01]
...
| 70. Keycloak behind the proxy | 9/10 | In Progress|  |
