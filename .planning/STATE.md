...
**2026-05-29 — Reader experience audit + session handoff.** [#25](https://github.com/szTheory/relyra/pull/25) doc fixes + `adopter_voice_test`; GitHub homepage → hexdocs. Deferred: D-12 badges, D-13 runbook wiring bridge. Thread: `.planning/threads/doc-reader-audit-2026-05-29.md`.
