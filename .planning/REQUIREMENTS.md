...
- [x] **ADOPT-05**: `docs/jtbd_gap_map.md` refreshed to v1.5 reality — incident playbook, generic SAML runbook, login trace, encrypted assertions, and SLO are marked shipped; stale "missing" rows removed.
