...
- [x] **DOCS-05**: Publish `guides/operations/incident_playbook.md` providing a narrative playbook that stitches together telemetry, audit events, the LiveView admin, and Mix tasks.
- [x] **DOCS-06**: Publish `guides/troubleshooting.md` acting as a SAML error atom decoder, paired with an automated drift-check test to ensure the documentation matches the code's error taxonomy.
...
| DOCS-05     | Phase 40 | Complete |
| DOCS-06     | Phase 40 | Complete |
