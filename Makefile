...
url:
	...
	@echo ""
	@echo "==> Admin trace prerequisite"
	@echo "  Choose and export DEMO_ADMIN_USERNAME and DEMO_ADMIN_PASSWORD before make up-build, make up-d-build, or make keycloak when you need operator-trace access."
	@echo "  The launcher names these runtime-only values but never prints or stores them."
	@echo ""
	@echo "==> Route map"
	...
	@echo "  401 recovery: set both values, restart the active demo, and authenticate at /login/admin."
	@echo ""
	@echo "==> Topology notes"
