...
## [1.5.0](https://github.com/szTheory/relyra/compare/v1.4.0...v1.5.0) (2026-05-27)
...
* **38-01:** add verify_redirect_signature for raw URL octet math ([f8954ac](https://github.com/szTheory/relyra/commit/f8954ac82a84f76dc594f3237a12621044c38f34))
* **38-01:** extend SessionAdapter for SLO indexing and termination ([eecacbb](https://github.com/szTheory/relyra/commit/eecacbb7af03070cb797eaaacabfccf8f138a809))
* **38-02:** implement LogoutRequest protocol model ([c12dea0](https://github.com/szTheory/relyra/commit/c12dea07ab119b157b313549716789b4b608eacb))
* **38-02:** implement LogoutResponse protocol model ([97a19f4](https://github.com/szTheory/relyra/commit/97a19f488d9ce84d8b3dbe921726eb08295dd1bd))
* **38-03:** implement LogoutValidator with strict pipelines ([95e83c6](https://github.com/szTheory/relyra/commit/95e83c63fed4e4d7fa8cca1cef4a47d9ae49d8b1))
* **38-04:** expose SLO flows via Relyra facade ([f8c9c98](https://github.com/szTheory/relyra/commit/f8c9c982b60919ee3b746d72d05a75aeca1256fa))
* **41-01:** add public XML attribute escaper module ([0f14c35](https://github.com/szTheory/relyra/commit/0f14c35d49fad07dd58142b2f06610cbf7637e38))
* **41-01:** escape dynamic metadata attribute values ([e9e1675](https://github.com/szTheory/relyra/commit/e9e1675fef3f0be3ed7d9698293b6ba1eb68a5f1))
* **41-03:** add wire-format byte spans to SaxyTree nodes ([57ffdea](https://github.com/szTheory/relyra/commit/57ffdea463e74c44e2147c3a9e39a860834bc5e7))
* **42-01:** add LoginTrace telemetry handler for consume spans ([43a1a4d](https://github.com/szTheory/relyra/commit/43a1a4dcbe128614d8bfaa156609fc7312961e6b))
* **42-01:** extend audit domain and actions for login traces ([8e8a7f7](https://github.com/szTheory/relyra/commit/8e8a7f7214caf510b18d457d5571b3d773314535))
* **42-01:** populate validation_trace and add login trace tests ([44f089c](https://github.com/szTheory/relyra/commit/44f089c425f34d68e32502906fffd30d132ea980))
* **42-02:** add login trace query and exclude login from trust audit ([fa2ec93](https://github.com/szTheory/relyra/commit/fa2ec93953c12721dff1dc881daf1c9aac3d8318))
* **42-02:** add LoginTrace.Export shared redaction module ([cae579d](https://github.com/szTheory/relyra/commit/cae579dcaa4ae2627793632f12b3bffd6f137d58))
* **42-03:** add ConnectionTraceLive route, page, and nav link ([6cc786e](https://github.com/szTheory/relyra/commit/6cc786e1f55f7ac3a668c12b44890c0fd880a8e5))
* **42-04:** add headless mix relyra.trace login trace CLI ([36ee5d9](https://github.com/szTheory/relyra/commit/36ee5d9c7c8567e0fc391cb9bc7398212559c1dd))
* implement Phase 35 signed AuthnRequests and Phase 37 UI tests ([1c79056](https://github.com/szTheory/relyra/commit/1c79056408ad8f9325d2e867555b76f36c67e28d))
...
* **38-04:** harden test adapters and corpus payload alignment ([82ba79f](https://github.com/szTheory/relyra/commit/82ba79f463b7a52ddb132ac1901138fefbf92a7a))
* **40.1:** scope drift gate to fenced elixir blocks (WR-01) ([35417db](https://github.com/szTheory/relyra/commit/35417dbc389d6d30343ead033b022fa7263e29b9))
* **41-02:** exclude test_support from prod compile and Hex package ([7315513](https://github.com/szTheory/relyra/commit/7315513392c579136563bce8bb7889a9400d1bca))
* **41:** close verification gaps for TD-04 and TD-05 ([4e143a4](https://github.com/szTheory/relyra/commit/4e143a44911f987b9dbd696741fe73bc896d0178))
